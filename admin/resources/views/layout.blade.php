            ...
            <div class="d-flex align-items-center ms-auto">
                ...
                <form action="{{ route('logout') }}" method="GET" class="d-inline">
                    <button type="submit" class="btn btn-link p-0 border-0">
                        <i class="fa-solid fa-right-from-bracket fa-xl me-4" style="color: #eb0000;"></i>
                    </button>
                </form>
            </div>
        </div>
    ...
    <div class="d-flex mt-5">
        <div id="sidebar" class="sidebar bg-white vh-100 position-fixed shadow">
            <nav class="nav flex-column pt-3">
                ...
                <a href="{{ route('kategori') }}" class="nav-link text-dark">
                    <i class="fa-solid fa-box"></i>
                    <span class="text ms-2">Kategori Produk</span>
                </a>
                <a href="{{ route('produk') }}" class="nav-link text-dark">
                    <i class="fa-solid fa-basket-shopping"></i>
                    <span class="text ms-2">Produk</span>
                </a>
                <a href="{{ route('testimoni') }}" class="nav-link text-dark">
                    <i class="fa-solid fa-comments"></i>
                    <span class="text ms-2">Testimoni</span>
                </a>
                <a href="{{ route('portfolio') }}" class="nav-link text-dark">
                    <i class="fa-solid fa-briefcase"></i>
                    <span class="text ms-2">Portfolio</span>
                </a>
                <a href="{{ route('kategorifaqs') }}" class="nav-link text-dark">
                    <i class="fa-solid fa-window-restore"></i>
                    <span class="text ms-2">Kategori FAQs</span>
                </a>
                <a href="{{ route('faqs') }}" class="nav-link text-dark">
